...
export function CTASection({
  ...
  return (
    <section className="relative overflow-hidden py-14 sm:py-20">
      ...
      <div className="pointer-events-none absolute -left-10 top-8 h-40 w-40 motion-safe-float rounded-full bg-orange-soft/25 blur-3xl" />
      <div className="pointer-events-none absolute bottom-0 right-10 h-48 w-48 motion-safe-float rounded-full bg-peach-300/40 blur-3xl" style={{ animationDelay: "1.5s" }} />
