  ...
  return (
    <div className="space-y-10">
      <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
        <Reveal variant="left" className="relative overflow-hidden rounded-[1.25rem] border border-border shadow-[var(--shadow-soft)] sm:rounded-[2rem]">
          <Image
        ...
        <Reveal variant="scale" delay={80}>
          <div className="rounded-[1.75rem] border border-orange-accent/20 bg-gradient-to-br from-peach-50 via-white to-peach-100/80 p-6 sm:flex sm:items-center sm:justify-between sm:gap-6 sm:p-8">
            ...
            <Link
              ...
              className="mt-5 flex w-full items-center justify-center gap-3 rounded-full bg-charcoal px-6 py-3.5 text-sm font-semibold text-white transition-all duration-300 hover:scale-[1.02] hover:bg-ink sm:mt-0 sm:inline-flex sm:w-auto"
            >
